...
use App\Models\store_request_history_approval;
use Carbon\Carbon;
use DateTime;

class Class_StoreRequestHistoryApproval
{
    /**
     * Read table
     */
    public function show($request)
    {
        ...
        try
        {
            $data_ = DB::table('store_request_history_approval');
            if($noTransaction!='')
            {
            ...
            $requestModule['class'] = 'Class_StoreRequestHistoryApproval';
    ...
    public function insert($request)
    {
        ...
        try
        {
            ...
            // else
            // {
                $data = new store_request_history_approval();
