...
class Class_ReceiveOrderDetail
{
    /**
     * Read table
     */
    ...
    {
        // set value variable
        $noTransaction=''; $codeItem=''; $description=''; $unit=''; $qty=''; $price=''; $subTotal=''; $expiredDate=''; $note='';
        $years='';
        ...
        try
        {
            $data_ = DB::table('receive_order_detail');
            if($noTransaction!='')
            {
            ...
            $requestModule['class'] = 'Class_ReceiveOrderDetail';
