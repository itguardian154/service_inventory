...
use App\Models\receive_order_history_approval;
use Carbon\Carbon;
use DateTime;

class Class_ReceiveOrderHistoryApproval
{
    /**
     * Read table
     */
    public function show($request)
    {
        ...
        try
        {
            $data_ = DB::table('receive_order_history_approval');
            if($noTransaction!='')
            {
            ...
            $requestModule['class'] = 'Class_ReceiveHistoryApproval';
    ...
    public function insert($request)
    {
        ...
        try
        {
            ...
            {
                $data = new receive_order_history_approval();
            ...
            $requestModule['reff'] = '-';
            $requestModule['service'] = 'Class';
            $requestModule['class'] = 'Class_ReceiveOrderHistoryApproval';
